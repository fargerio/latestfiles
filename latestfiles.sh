...
printf '.css" media="all" rel="stylesheet" type="text/css" />\n<script src="sorttable.js"></script>\n</head>\n' >> "$TEMP_FILE"

SDATE=$(date +"%Y-%m-%d" --date="1 days ago")
touch --date "$SDATE" "$START"
printf '<body>\n<h1>Today</h1>\n<table class="sortable">\n<thead><tr><th>type</th><th>name</th><th>size</th><th>time</th></tr></thead>\n' >> "$TEMP_FILE"
...
do
	...
	printf '<h1>%s</h1><table class="sortable">\n<thead>\n<tr><th>type</th><th>name</th><th>size</th><th>time</th></tr></thead>' "$SDATE" >> "$TEMP_FILE"
